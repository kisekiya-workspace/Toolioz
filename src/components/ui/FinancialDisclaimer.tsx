...
export const FinancialDisclaimer: React.FC<FinancialDisclaimerProps> = ({
  ...
  return (
    <div
      className={`rounded-2xl border border-amber-200/80 bg-amber-50/60 p-6 text-amber-950 shadow-sm backdrop-blur-sm sm:p-8 ${className}`}
    >
