...
export const toolGuideLinks: ToolGuideLink[] = [
  ...
  { toolSuffix: 'timestamp-converter', title: 'Unix timestamps: seconds, milliseconds, and dates', href: '/devtools/timestamp-converter', category: 'Developer guide' },
  ...
  { toolSuffix: 'mortgage-calculator', title: 'Home loan EMI and prepayment guide', href: '/how-to/reduce-home-loan-interest', category: 'Finance guide' },
  { toolSuffix: 'compress-pdf', title: 'How to compress a PDF under 2MB', href: '/how-to/compress-pdf-under-2mb', category: 'PDF guide' },
  { toolSuffix: 'merge-pdf', title: 'How to merge PDFs in the browser', href: '/pdftools/merge-pdf', category: 'PDF guide' },
  ...
  { toolSuffix: 'resume-builder', title: 'ATS resume builder', href: '/resume-builder', category: 'Resume guide' },
];
