...
export const metadata = buildPageMetadata({ title: 'Percentage Increase or Decrease Calculator', description: 'The calculator measures percentage increase or decrease from old to new values and shows the signed rate, absolute change, formula, and steps.', path: config.path, keywords: ['percentage increase decrease calculator with steps', 'percentage change from old to new value', 'salary percentage increase calculator', 'percentage decrease calculator'] });
