...
export const metadata = buildPageMetadata({ title: 'Average Percentage Calculator', description: 'Finds the arithmetic mean of multiple percentages and shows the count, range, total, formula, and weighted-average warning.', path: config.path, robots: { index: false, follow: true }, keywords: ['average percentage calculator', 'average of percentages calculator', 'calculate mean percentage', 'multiple percentage average'] });
